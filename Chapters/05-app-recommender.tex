...
\item \textbf{Disponibilidade de dados estatísticos.} A base de dados do
   ...
   em fevereiro de 2011. É a maior coleção de dados disponível atualmente
   sobre a utilização de pacotes Debian, compondo uma importante fonte de
   informação para a realização de estratégias colaborativas de recomendação.
...
\section{Proposta de Solução: AppRecommender}

\begin{figure}[h!]
\centering
  \includegraphics[width=\textwidth]{Figures/diagrama_apprec.pdf}
\caption{Fluxo de dados no AppRecommender}
